...
one atom producing a true positive, i.e.\ it correctly identifies a human. In both cases $\Phi$ does not belong to allocation bases for false negatives.% Again, this consideration emphasizes the importance to maximize the true positive rate.
